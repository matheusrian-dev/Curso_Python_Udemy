...
# seria possível acessar a variável, transformando-a em global,
# porém é uma má prática.
x = 1
...
def escopo():
    ...
    def outra_funcao():
        y = 2
        # como essa função está dentro da função(escopo) onde a
        # foi declarada, ela consegue acessar a variável.
        print(x, y)
    ...
    # print(y)
    print(x)
    # resumindo: escopos filhos conseguem acessar
    # variáveis dos pais mas o inverso não é possível.


print(x)
escopo()
# alterar uma variável dentro de um escopo interno não altera
# a mesma no externo, são variáveis distintas com o mesmo nome.
print(x)
