...
# o map não gera uma lista por padrão e sim um map object
# é necessário evidenciar que precisa de uma lista para ele
# tratar o objeto como tal.
# novos_produtos = map(muda_preco_de_produtos, produtos)
print(novos_produtos)
# O map object é um iterator
