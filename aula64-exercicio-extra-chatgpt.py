"""
Criar um script que gere senhas seguras e personalizáveis com base nas escolhas do usuário.
...
def valida_numero(numero):
    try:
        ...
        print('Gentileza inserir uma quantidade válida de caracteres (apenas números).')
        return False
    return True
...
while repeat:
    ...
    tamanho_senha = input('Insira a quantidade de caracteres deseja em sua senha: ')
    if(valida_numero(tamanho_senha) is not True):
        repetir_programa()
    else:
        while perguntar:
            resposta_maiuscula = input('Gostaria de inserir letras maiúsculas na senha? Digite sim para inserir e não caso contrário: ').lower()
        ...
        perguntar = True
        while perguntar:
            resposta_minuscula = input('Gostaria de inserir letras minúsculas na senha? Digite sim para inserir e não caso contrário: ').lower()
        ...
        perguntar = True
        while perguntar:
            resposta_numero = input('Gostaria de inserir números na senha? Digite sim para inserir e não caso contrário: ').lower()
        ...
        perguntar = True
        while perguntar:
            resposta_caractere_especial = input('Gostaria de inserir caracteres especiais na senha? Digite sim para inserir e não caso contrário: ').lower()
        ...
        senha = gerador_senha(tamanho_senha, tem_maiuscula, tem_minuscula, tem_numero, tem_caractere_especial)
        print(f'Sua senha foi gerada: {senha}')
        tem_maiuscula = tem_minuscula = tem_numero = tem_caractere_especial = False
...
# def gerar_senha(tamanho, usar_maiusculas, usar_minusculas, usar_numeros, usar_especiais):
#     caracteres = ''
#     if usar_maiusculas:
#         caracteres += string.ascii_uppercase
#     if usar_minusculas:
