...
# utilize o replace para remover caracteres simples
# como pontuações de alguns dados que precisam ser tratados.
...
# regex abaixo faz com que substitua tudo que
# não seja números de 0 a 9 pelo valor passado
...
try:
    if len(cpf) != 11:
        # Força IndexError caso a quantidade de caracteres passada for
        # diferente de 11 caracteres
        raise IndexError()
